<%@ Page Title="" Language="C#" MasterPageFile="~/Provider/ProfileMasterPage.master" AutoEventWireup="true" CodeFile="UpdateProviderJobExperience.aspx.cs" Inherits="Provider_JobExperience_UpdateProviderJobExperience" %>
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        ...
                        <asp:ImageButton ID="LinkDeleteToolUsed" ImageUrl="~/Images/delete.gif" runat="server"
                            OnClick="LinkDeleteToolUsed_Click" Style="height: 16px" />
                        <br />
